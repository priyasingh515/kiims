...
<div class="main-content">
    ...
    <div class="rs-breadcrumbs breadcrumbs-overlay">
        ...
        <div class="breadcrumbs-text white-color">
            <h1 class="page-title">ANM ( Auxiliary Nursing Midwifery) Course</h1>
            <ul>
                <li>
                    ...
                    <div class="intro-info-tabs">
                        ...
                        <div class="tab-content tabs-content" id="myTabContent">
                            <div class="tab-pane tab fade show active" id="prod-overview" role="tabpanel" aria-labelledby="prod-overview-tab">
                                <div class="content white-bg pt-30">
                                    ...
                                    <div class="course-overview">
                                        <div class="inner-box">
                                            <h4>ANM (Auxiliary Nursing Midwifery) Course</h4>
                                            <h3>What you’ll learn?</h3>
                                            <p>
                                                The ANM (Auxiliary Nursing Midwifery) course focuses on providing students with essential skills to care for patients, including maternal and child healthcare, emergency medical procedures, and nursing practices in different healthcare settings.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="prod-curriculum" role="tabpanel" aria-labelledby="prod-curriculum-tab">
                                <div class="content pt-30 pb-30 pl-30 pr-30 white-bg">
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            <td>Maternity and Child Health Nursing</td>
                                            <th>1st Year</th>
                                        </tr>
                                        <tr>
                            ...
                            <div class="tab-pane fade" id="prod-instructor" role="tabpanel" aria-labelledby="prod-instructor-tab">
                                <div class="content pt-30 pb-30 pl-30 pr-30 white-bg">
                                    <p>
                                        Candidates must have completed 10+2 with at least 45% marks from a recognized board. The program is open to both male and female candidates who wish to serve in the healthcare sector.
                                    </p>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="prod-faq" role="tabpanel" aria-labelledby="prod-faq-tab">
                                <div class="content pt-30 pb-30 pl-30 pr-30 white-bg">
                                    <p>The admission process for the ANM course is as follows:</p>
                                    <ul style="list-style: circle;">
                                        <li>Fill out the application form online or offline.</li>
                                        <li>Submit the required documents like class 12th marksheet, ID proof, etc.</li>
                                        <li>After verification, the candidates will receive an admission confirmation.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="video-column col-lg-4">
                    <div class="inner-column">
                        ...
                        <div class="intro-video media-icon orange-color2">
                            <img class="video-img" src="/public/assets/images/courses/anm.webp" alt="Video Image">
                        </div>
                        <!-- End Video Box -->
                        <div class="course-features-info">
                            <ul>
                                <li class="duration-feature">
                                    ...
                                    <span class="value">1 yrs + 6 months Internship</span>
                                </li>
                                <li class="lectures-feature">
                                    <i class="fa fa-files-o"></i>
                                    <span class="label">Eligibility :</span>
                                    <span class="value">12th Pass Any Streams</span>
                                </li>
                                <li class="lectures-feature">
                                    <i class="fa fa-files-o"></i>
