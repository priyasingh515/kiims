...
<div class="main-content">
    ...
    <div class="rs-breadcrumbs breadcrumbs-overlay">
        ...
        <div class="breadcrumbs-text white-color">
            <h1 class="page-title">GNM ( General Nursing and Midwifery )Course</h1>
            <ul>
                <li>
                    ...
                    <div class="intro-info-tabs">
                        ...
                        <div class="tab-content tabs-content" id="myTabContent">
                            <div class="tab-pane tab fade show active" id="prod-overview" role="tabpanel" aria-labelledby="prod-overview-tab">
                                <div class="content white-bg pt-30">
                                    ...
                                    <div class="course-overview">
                                        <div class="inner-box">
                                            <h4>GNM (General Nursing and Midwifery) Course</h4>
                                            <h3>What you’ll learn?</h3>
                                            <p>
                                                The General Nursing and Midwifery (GNM) course is designed for students who want to pursue a career in nursing, providing them with comprehensive knowledge of healthcare practices, nursing skills, and midwifery to care for patients across different healthcare settings.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="prod-instructor" role="tabpanel" aria-labelledby="prod-instructor-tab">
                                <div class="content pt-30 pb-30 pl-30 pr-30 white-bg">
                                    <p>
                                        Candidates should have passed the 12th examination in Science (Physics, Chemistry, Biology) with a minimum of 45% marks. Candidates should have a passion for serving humanity and a career in nursing.
                                    </p>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="prod-faq" role="tabpanel" aria-labelledby="prod-faq-tab">
                                <div class="content pt-30 pb-30 pl-30 pr-30 white-bg">
                                    <p>The admission process for the GNM course includes:</p>
                                    <ul style="list-style: circle;">
                                        <li>Submission of the application form.</li>
                                        <li>Verification of documents and eligibility criteria.</li>
                                        <li>Completion of entrance exams (if applicable).</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="video-column col-lg-4">
                    <div class="inner-column">
                        ...
                        <div class="intro-video media-icon orange-color2">
                            <img class="video-img" src="/public/assets/images/courses/gnm.webp" alt="Video Image">
                        </div>
                        <!-- End Video Box -->
                        <div class="course-features-info">
                            <ul>
                                <li class="duration-feature">
                                    ...
                                    <span class="value">3 years + 6 months Internship</span>
                                </li>
