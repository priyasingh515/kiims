...
<div class="main-content">
    ...
    <div class="rs-breadcrumbs breadcrumbs-overlay">
        ...
        <div class="breadcrumbs-text white-color">
            <h1 class="page-title">Ophthalmic Technology</h1>
            <ul>
                <li>
                    ...
                    <div class="intro-info-tabs">
                        ...
                        <div class="tab-content tabs-content" id="myTabContent">
                                ...
                                <div class="content white-bg pt-30">
                                    ...
                                    <div class="course-overview">
                                        <div class="inner-box">
                                            ...
                                            <p>
                                                Ophthalmic Technology is a specialized field of healthcare focused on diagnosing and treating eye-related conditions. This course prepares students for a career in eye care by teaching them about vision tests, refractive errors, and the management of patients in ophthalmology departments.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="prod-curriculum" role="tabpanel" aria-labelledby="prod-curriculum-tab">
                                <div class="content pt-30 pb-30 pl-30 pr-30 white-bg">
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            <td>Basic Anatomy & Physiology</td>
                                            <th>1st Year</th>
                                        </tr>
                                        <tr>
                                            <td>Ophthalmic Optics</td>
                                            <th>1st Year</th>
                                        </tr>
                                        <tr>
                                            <td>Eye Diseases & Disorders</td>
                                            <th>1st Year</th>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td>Refraction Techniques</td>
                                            <th>2nd Year</th>
                                        </tr>
                                        <tr>
                                            <td>Ocular Pharmacology</td>
                                            <th>2nd Year</th>
                                        </tr>
                                        <tr>
                                            <td>Ophthalmic Surgery Assisting</td>
                                            <th>2nd Year</th>
                                        </tr>
                                        <tr>
                                            <td>Clinical Ophthalmology</td>
                                            <th>2nd Year</th>
                                        </tr>
                                    </table>
                                </div>
                            ...
                            <div class="tab-pane fade" id="prod-instructor" role="tabpanel" aria-labelledby="prod-instructor-tab">
                                <div class="content pt-30 pb-30 pl-30 pr-30 white-bg">
                                    <p>
                                        Eligibility requires completion of the 12th grade from a recognized board, preferably in the science stream (Physics, Chemistry, and Biology). Some institutions may allow non-science stream students based on their respective criteria.
                                    </p>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="prod-faq" role="tabpanel" aria-labelledby="prod-faq-tab">
                                <div class="content pt-30 pb-30 pl-30 pr-30 white-bg">
                                    <p>The admission process for the Ophthalmic Technology course is as follows:</p>
                                    <ul style="list-style: circle;">
                                        <li>Visit the website of the institution offering the course.</li>
                                        <li>Fill out the admission form available under the admissions section.</li>
                                        <li>You may contact the institution directly for further assistance.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="video-column col-lg-4">
                    <div class="inner-column">
                        ...
                        <div class="intro-video media-icon orange-color2">
                            <img class="video-img" src="/public/assets/images/about/opthalmic.jpg" alt="Video Image">
                        </div>
                        <!-- End Video Box -->
